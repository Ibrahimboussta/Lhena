            ...
            <div class="flex justify-between pt-6 w-full">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-6 w-full">
                    ...
                    <a href="{{ route('proprites.details', $property->slug) }}" class="w-full">
                        <div class="w-full rounded-2xl border border-[#e0dede] p-2 hover:shadow duration-400 relative z-0">
                            <!-- Image Section with Positioned Labels -->
                            <div class="relative">
                                <div class="relative overflow-hidden rounded-2xl">
                                    <div class="absolute inset-0 skeleton skeleton-animate rounded-2xl"></div>
                                    <img class="w-full h-80 object-cover rounded-2xl opacity-0 transition-[opacity,transform] duration-300 hover:scale-[1.02]" src="{{ asset('storage/' . json_decode($property->photos)[0]) }}" alt="" loading="lazy" decoding="async" onload="this.classList.remove('opacity-0'); this.previousElementSibling.classList.add('opacity-0'); this.previousElementSibling.classList.remove('skeleton-animate');">
                                </div>

                                <!-- Labels -->
                                <div class="absolute top-4 left-4 flex space-x-2">
                                    @if (strpos($property->listing_type, 'À-vendre') !== false)
                                    <span class="text-white bg-[#25D366] rounded-lg px-3 py-1 uppercase font-medium text-xs">
                                        À vendre
                                    </span>
                                    @endif
                                    @if (strpos($property->listing_type, 'À-louer') !== false)
                                    <span class="text-white bg-[#E7C873] rounded-lg px-3 py-1 uppercase font-medium text-xs">
                                        À louer
                                    </span>
                                    @endif
                                </div>
                            ...
                            <div class="pt-2 px-1">
                                ...
                                <!-- Property Type -->
                                <p class="font-medium text-[#8b8b8b] text-[15px] truncate">
                                ...
                                <div class="flex justify-between items-center gap-2">
                                    ...
                                    <!-- Title -->
                                    <p class="font-semibold text-[#1A1A1A] text-lg truncate flex-1">
                                        {{ $property->title }}
                                    </p>

                                    <!-- Price -->
                                    <p class="font-semibold text-xl text-[#25D366] whitespace-nowrap">
                                        {{ $property->price }} DH
                                    </p>
                                ...
                                <div class="flex items-center space-x-1 pt-1">
                                    <img src="{{ asset('images/local.svg') }}" class="w-4 h-4" loading="lazy">
