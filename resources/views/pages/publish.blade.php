                        ...
                        <div class="flex flex-wrap items-center gap-6 pb-4">
                            <div class="flex items-center gap-4">
                                <label class="cursor-pointer">
                                    <input type="checkbox" name="listing_type[]" value="À-vendre" class="sr-only peer" {{ in_array('À-vendre', old('listing_type', [])) ? 'checked' : '' }}>
                                    <span class="inline-flex items-center justify-center px-4 py-2 rounded-full border border-gray-200 text-sm font-semibold text-gray-700 bg-white transition peer-checked:bg-green-600 peer-checked:text-white peer-checked:border-green-600">
                                        À vendre (للبيع)
                                    </span>
                                </label>
                                <label class="cursor-pointer">
                                    <input type="checkbox" name="listing_type[]" value="À-louer" class="sr-only peer" {{ in_array('À-louer', old('listing_type', [])) ? 'checked' : '' }}>
                                    <span class="inline-flex items-center justify-center px-4 py-2 rounded-full border border-gray-200 text-sm font-semibold text-gray-700 bg-white transition peer-checked:bg-blue-600 peer-checked:text-white peer-checked:border-blue-600">
                                        À louer (للكراء)
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="w-full grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <label class="cursor-pointer">
                                    <input type="radio" name="price_type" value="{{ $val }}" {{ old('price_type', '') === $val ? 'checked' : '' }} class="sr-only peer">
                                    <span class="inline-flex w-full items-center justify-center px-4 py-2 rounded-full border border-gray-200 text-sm font-semibold text-gray-700 bg-white transition peer-checked:bg-green-600 peer-checked:text-white peer-checked:border-green-600">
                                        {{ $label }}
                                    </span>
                                </label>
                                @endforeach
