    ...
    <div class="sm:flex items-center max-w-screen-xl">
        <div class="sm:w-1/2 p-10">
            <div class="image object-center text-center">
                <img src="{{ asset('images/appart1.jpg') }}" alt="">
            </div>
        </div>
        <div class="sm:w-1/2 p-5">
            <div class="text">
                <span class="text-gray-500 border-b-2 border-[#25D366] uppercase">Qui sommes nous?</span>
                <h2 class="my-4 font-bold text-3xl  sm:text-4xl ">A Propos   <span class="text-[#25D366]"> De Nous</span>
                </h2>
    ...
    <div class="h-full  w-full  pt-12 p-4">
        <div class="grid gap-14 md:grid-cols-3 md:gap-5">
            <div class="rounded-xl bg-white p-6 text-center border border-[#e0dede] shadow">
                ...
                <p class="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore
                    amet
                    modi
        ...
        <div class="flex justify-center pt-6">
            <button class="bg-[#E7C873] py-2 px-6 rounded-md border-0">
                <a href="{{route('contact')}}" class="text-black font-medium text-md flex items-center gap-x-2">
                    Contactez-nous
