    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 sm:p-8">
                <form action="{{ route('dashboard.update', $property->slug) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex flex-col gap-3 pt-6 border-t border-gray-200">
                        ...
                        <a href="{{ route('dashboard') }}" class="w-full text-center px-6 py-2.5 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition font-medium">
                            Annuler
                        </a>
                    </div>
                </form>
