<div class="pt-10 md:pt-10 px-10 container mx-auto flex flex-col md:flex-row  overflow-hidden" x-data="{ testimonialActive: 2 }"
        ...
        <div
            ...
            <div
                class="relative text-2xl md:text-5xl py-2 px-6 md:py-6 md:px-1 md:w-64 md:mx-auto text-black font-semibold leading-tight tracking-tight mb-0 z-20">
            ...
            <div class="absolute right-0 bottom-0 mr-4 mb-4 hidden md:block">
                <button
                    ...
                    class="rounded-r-full bg-gray-100 text-gray-500 focus:outline-none hover:text-black font-bold w-12 h-10"
        ...
        <div class="bg-gray-100 rounded-r-xl md:w-1/2">
            <div class="flex flex-col h-full relative">
                ...
                <div class="absolute top-0 left-0 mt-3 ml-4 md:mt-5 md:ml-12">
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-[#25D366] fill-current w-12 h-12 md:w-16 md:h-16"
                        viewBox="0 0 24 24">
                        <path
