<section class="px-6 sm:px-16 py-8">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center pt-2">
        <p class="text-[15px] font-medium">
            Découvrez les Meilleures Propriétés du Moment
        </p>
    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-6 w-full">
            ...
            @foreach ($properties->take(9) as $property)
                <a href="{{ route('proprites.details', $property->slug) }}" class="w-full group">
                    ...
                    <div
                        class="w-full h-[460px] rounded-2xl border border-gray-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition duration-300 flex flex-col">
                                ...
                                <div class="flex justify-between items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center space-x-1 text-gray-600 text-sm mt-1">
                                            <img src="{{ asset('images/local.svg') }}" class="w-4 h-4 opacity-70" alt="">
                                    ...
                                    <!-- Price (FIXED WIDTH) -->
                                    <p
                                        class="font-semibold text-lg text-emerald-600 whitespace-nowrap text-right min-w-[110px]">
