        ...
        <div class="max-w-7xl mx-auto  w-full">
            ...
            <div class="hero-section flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-0">
                ...
                rounded-lg hover:bg-green-700 transition-all duration-200">
                    ...
                    @endauth
                    <a href="{{ route('contact') }}" class="inline-flex items-center justify-center bg-white text-black px-6 py-2.5 text-xs font-medium border border-gray-200 rounded-lg hover:bg-gray-50 transition-all duration-200">
                        Contactez-nous
                    </a>
                </div>
            </div>
