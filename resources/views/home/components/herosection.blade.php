...
<section>
    <div class="herosection flex items-center justify-center text-black text-center px-6 relative">
        ...
        <div class="z-10 max-w-2xl text-center mx-auto py-20 sm:pt-0">
            ...
            <h1 class="text-3xl md:text-6xl pt-14 sm:pt-20  font-bold leading-tight drop-shadow-lg">
            ...
            class="hidden md:flex w-full md:w-fit flex flex-col md:flex-row items-center gap-3 mt-5 bg-white px-4 py-3 rounded-lg shadow-md">
        
            <!-- Search Bar -->
            <input type="text" name="query" placeholder="Rechercher un bien..."
                class="w-full md:w-auto px-4 py-2 border text-black border-[#25D366] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#25D366] transition duration-200" />
