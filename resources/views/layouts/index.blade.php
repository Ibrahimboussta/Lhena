        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
            <div
                ...
                <div class="flex mt-4 space-x-4 sm:justify-center sm:mt-0 ">
                    <a href="javascript:;"
                        class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-[#25D366]">
            ...
            <div
                ...
                <div
                    ...
                    <div class="block">
                        ...
                        <ul class="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
                            ...
                            <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Components
                                    Library</a>
                            </li>
                        </ul>
                    </div>
                    <div class="block">
                        ...
                        <ul class="grid gap-4 min-[500px]:gap-6 text-center min-[500px]:text-left">
                            ...
                            <li><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Documentation</a>
                            </li>
                ...
                <div class="block w-full max-w-lg mx-auto px-4">
                    <!-- Titre -->
                    <h3
                        class="font-manrope font-semibold text-2xl text-gray-900 leading-9 mb-6 text-center lg:text-left">
